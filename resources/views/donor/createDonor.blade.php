...
@section('content')
    ...
    <div class="container mt-5">
        <form action="{{route('createDonor')}}" method="post" class="row g-3 shadow-lg p-3 mb-5 bg-body rounded">
            ...
            <div class="col-md-2">
              ...
              <select class="form-select" name="smoker" value="{{ old("smoker") }}">
            ...
            <div class="col-md-2">
              ...
              <select class="form-select" name="disease" value="{{ old("disease") }}">
                <option value="1">Sim</option>
                <option value="0">Não</option>
              </select>
            </div>
