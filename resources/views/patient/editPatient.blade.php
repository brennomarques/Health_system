...
@section('content')
    ...
    <div class="d-flex justify-content-center mt-5" style="color: #013d52;">
        <h1>Atualizar Paciente {{ $patient->name }}</h1>
    </div>

    <div class="container mt-5">
        <form action="{{route('updatePatient', $patient->id)}}" method="post" class="row g-3 shadow-lg p-3 mb-5 bg-body rounded">
            ...
            <div class="col-md-3">
              ...
              <select class="form-select" name="is_donor" value="{{ $patient->is_donor }}">
